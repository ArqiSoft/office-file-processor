...
public class ExtractMeta extends AbstractContract {
    ...
    public ExtractMeta() {
        ...
        contractName = ExtractMeta.class.getSimpleName();
    }
    ...
    public String toString() {
        return String.format("%s [id=%s, blobId=%s, bucket=%s, userId=%s, namespace=%s, contractName=%s, correlationId=%s]",
                ExtractMeta.class.getSimpleName(), id, blobId, bucket, userId, namespace, contractName, getCorrelationId());
    }
